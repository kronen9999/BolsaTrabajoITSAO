    ...
    if (etiquetaAltac) {
        etiquetaAltac.addEventListener("click", function(e) {
            ...
            contenedorFormulario.innerHTML = `
                 <form id="contenedor_form_alta" action="../php/AltaRepresentantes.php" method="post" animacionActiva="Si" >
                    <h2>Agregarse como Representante</h2>
                    <div id=contenedor_form_alta_divp>
                    <div id="contenedor_form_alta_div1">
                    <img src="../assets/Imagenes/ImagenesInicioRepresentantes/iconoRepresentanteagregar.png" alt="iconoRepresentantes">
                    </div>
            ...
            botonCancelar.addEventListener("click", function(e) {
                contenedorFormulario.innerHTML = `
                <form id="contenedor_form" action="../php/ComprobarRepresentantes.php" method="post" animacionActiva="Si">
                ...
                <div style="display: flex;" ><p style="font-size: 15px;">Aun no tienes una cuenta?<p style="color:blue" >da click aqui para registrase</p></p></div>
