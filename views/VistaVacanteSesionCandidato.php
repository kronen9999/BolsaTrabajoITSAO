...
<head>
    ...
    <link rel="stylesheet" href="../css/VistaVacanteSesionCandidato.css">
    <title>Bienvenido a BOLSA DE TRABAJO ITSAO</title>
</head>
<body>
<div class="difuminar" style="width: 100vw; height: 100vh; backdrop-filter: blur(0px); background: rgb(255, 255, 255 /30%); position:fixed; z-index: -1;"></div>
...
<img src="<?php 
  ...
  <header>
         <img src="../assets/Imagenes/ImagenesBusquedaVacanteSesionCandidato/LogoRecluTrabajo.png" alt="Logotipo">
         <p>BOLSA DE TRABAJO ITSAO</p>
        <nav>
           
            <ul>
            <li><a href="BusquedaVacantesSesionCandidato.php" style="margin-right: 10px;">Busqueda</a></li>
...
while($fila=$resultado->fetch_assoc()){
   ...
   echo "<p titulo='1'>$nombreVacante</p>
         ...
         <p titulo='1'><b>Vacante:</b> $nombreVacante</p>
        ...
        <input type='submit' value='Postularse' name='btnPostularse'>
...
<footer>
    ...
    <div class="divfooter_img">
        ...
        <a href="https:whatsapp.cm" target="blank"><img src="../assets/Imagenes/ImagenesBusquedaVacanteSesionCandidato/iconoWhatsapp.png" alt="iconoWhatsapp"></a>
        <a href="https:github.com" target="blank"><img src="../assets/Imagenes/ImagenesBusquedaVacanteSesionCandidato/iconoGithub.png" alt="iconoGit"></a>
        <a href="https:x.com" target="blank"><img src="../assets/Imagenes/ImagenesBusquedaVacanteSesionCandidato/iconoX.png" alt="iconoX"></a>
    </div>
    
    </footer>
  <script src="../js/VistaVacanteSesionCandidato.js"></script>
